...
<h2 align="center" style="font-family: 'Times New Roman', serif; font-weight: bold;">
  🚀 Innovating with Code | Passionate About IoT, AI/ML, and Game Development
</h2>
...
<ul style="font-family: 'Times New Roman', serif; font-weight: bold; font-size: 18px;">
  ...
  <li>📊 Experienced in Machine Learning, Data Science, and Predictive Analytics.</li>
  <li>🎮 Developed an AI-Powered Game in Unreal Engine 5.</li>
  <li>🔬 Research background: Authored a paper on AI & IoT for Cybersecurity.</li>
  <li>🏆 National Hackathon Finalist: HackSavvy-24.</li>
  <li>👨‍💻 Actively solving LeetCode & DSA problems to sharpen problem-solving skills.</li>
</ul>
...
<ul style="font-family: 'Times New Roman', serif; font-weight: bold; font-size: 18px;">
  ...
  <li>🌱 Learning Scikit-Learn, Keras, PyTorch.</li>
  <li>💬 Ask me about Algorithms, Data Structures, and AI/ML Concepts.</li>
  <li>📫 Reach me at: kanuragh03@gmail.com</li>
  <li>⚡ Fun fact: I connect things to the internet... sometimes even my coffee mug! ☕🌐 😆</li>
</ul>
...
<ul style="font-family: 'Times New Roman', serif; font-weight: bold; font-size: 18px;">
  ...
  <li>🏆 HackSavvy-24 Finalist: Competed at the National Hackathon Level.</li>
  <li>🛠️ Developed IoT-based Smart Gas Leakage Detector (ESP32, Firebase, Python).</li>
  <li>🔍 Built an ML-Based Diabetes Prediction System (KNN Algorithm, Python, NumPy).</li>
  <li>🎮 Created a First-Person Exploration Game (Unreal Engine 5, C++).</li>
  <li>🎖️ Class Representative & Volunteer at Sreenidhi Cancer Foundation.</li>
</ul>
...
👉 Endorse my skills & recommend me on LinkedIn: 
<a href="https://linkedin.com/in/anuraghkamble" target="blank">linkedin.com/in/anuraghkamble</a>
</p>
...
<p align="left">
  ...
  <a href="https://instagram.com/anuragh._kb" target="blank">
